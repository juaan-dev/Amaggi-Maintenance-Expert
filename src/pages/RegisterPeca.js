...
const RegisterPeca = ({ navigation }) => {
  ...
  let register_peca = () => {
    ...
    db.transaction(function (tx) {
      tx.executeSql(
        'INSERT INTO peca (nome, modelo, composicao, referencia) VALUES (?,?,?,?)',
        ...
        (tx, results) => {
          ...
          } else alert('Erro ao tentar Registrar a Peça !!!');
        }
      );
    });
  };
          ...
          <ScrollView keyboardShouldPersistTaps="handled">
            <KeyboardAvoidingView
              ...
              <Mytextinput
                ...
                style={{ textAlignVertical: 'top', padding: 10 }}
              />
              <Mybutton title="Salvar" customClick={register_peca} />
            </KeyboardAvoidingView>
          </ScrollView>
        </View>
      </View>
